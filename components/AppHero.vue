<template>
  ...
  <div class="px-4 py-12 mx-auto 2xl:max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24 2xl:px-12">
    <div class="flex  items-center mx-auto 2xl:max-w-7xl">
      <div class="flex flex-col items-start mb-16 text-left lg:flex-grow lg:w-1/2 lg:pr-24 md:mb-0">
        ...
        <p class="mb-8 text-base leading-relaxed text-left text-gray-400">Free and Premium themes, UI Kit's, templates and landing pages built with Tailwind CSS, HTML &amp; Next.js.</p>
      ...
      <div class="w-full mt-12 lg:w-5/6 lg:max-w-lg xl:mt-0 hidden md:block">
        <div>
          <div class="relative w-full max-w-lg">
            ...
            <div class="relative">
              <img class="object-cover object-center mx-auto shadow-2xl max-h-96 w-full" alt="hero" src="https://source.unsplash.com/random?code">
            </div>
          </div>
        </div>
      </div>
